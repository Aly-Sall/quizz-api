        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    _Choices = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestQuestionJoinTable", x => new { x.QuestionsId, x.QuizTestsId });
                    table.ForeignKey(
                        name: "FK_TestQuestionJoinTable_Questions_QuestionsId",
                        column: x => x.QuestionsId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestQuestionJoinTable_Tests_QuizTestsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestQuestionJoinTable_QuizTestsId",
                table: "TestQuestionJoinTable",
                column: "QuizTestsId");
        }
