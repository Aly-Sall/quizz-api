...
namespace _Net6CleanArchitectureQuizzApp.Infrastructure.Migrations
{
    ...
    [Migration("20250617165328_AddUserRoleAndLastLoginDate")]
    partial class AddUserRoleAndLastLoginDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CandidateAccessToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CandidateAccessTokens");
                });
            ...
            modelBuilder.Entity("CandidateAccessToken", b =>
                {
                    b.HasOne("_Net6CleanArchitectureQuizzApp.Domain.Entities.User", "User")
                        .WithMany("CandidateAccessTokens")
            ...
            modelBuilder.Entity("_Net6CleanArchitectureQuizzApp.Domain.Entities.User", b =>
                {
                    b.Navigation("CandidateAccessTokens");
                });
